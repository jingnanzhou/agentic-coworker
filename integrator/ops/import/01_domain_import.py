...
def main(backup_dir=None, clear_existing=False):
    ...
    try:
        with get_db_cm() as sess:
            ...
            if success:
                sess.commit()
                logger.info("Domain import completed successfully")
            else:
                sess.rollback()
...
#    backup_dir="/Users/jingnan.zhou/workspace/aintegrator/data/backup_data/20260126_142613/domains_all"
    ...
    success = main(backup_dir, clear_existing)
